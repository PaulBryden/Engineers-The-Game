...
import {EventConstants, StartOfGame} from './GameConstants'
class UIResources extends Phaser.GameObjects.Container
{
    ...
    constructor(scene:Phaser.Scene)
    {
        ...
        this.resourceCount = new Phaser.GameObjects.Text(scene, 65, 0, this.resourceCountString,{ fontFamily: 'Courier', fontSize: '18px', color: '#ffffff' } );
        ...
        this.eventEmitter.on(EventConstants.Game.UpdateResourceCount,(count:number)=>{console.log(this); this.resourceCount.setText(count.toString())});
