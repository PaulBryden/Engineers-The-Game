...
class AIPlayer 
{
    ...
    BuildingFSM() 
    {
        if(this.running) 
        {
            const Engineers = this.entityManager.getAllEntitiesByTypeAndTeam(EntityID.Engineer, this.teamNumber);
            const Bases = this.entityManager.getAllEntitiesByTypeAndTeam(BuildingEntityID.Base, this.teamNumber);
            const Factories = this.entityManager.getAllEntitiesByTypeAndTeam(BuildingEntityID.Factory, this.teamNumber);
    ...
    AttackingFSM() 
    {
        ...
        if(this.running) 
        {
            ...
            const Gliders = this.entityManager.getAllEntitiesByTypeAndTeam(EntityID.Glider, this.teamNumber);
            const enemyTurrets = this.entityManager.getAllEntitiesByTypeAndTeam(BuildingEntityID.Turret, this.enemyTeam);
            const enemyGliders = this.entityManager.getAllEntitiesByTypeAndTeam(EntityID.Glider, this.enemyTeam);
            const enemyBases = this.entityManager.getAllEntitiesByTypeAndTeam(BuildingEntityID.Base, this.enemyTeam);
            const enemyEngineers = this.entityManager.getAllEntitiesByTypeAndTeam(EntityID.Engineer, this.enemyTeam);
            const enemyFactories= this.entityManager.getAllEntitiesByTypeAndTeam(BuildingEntityID.Factory, this.enemyTeam);
    ...
    MiningFSM() 
    {
        ...
        {
            const Engineers = this.entityManager.getAllEntitiesByTypeAndTeam(EntityID.Engineer, this.teamNumber);
            const Mines = this.entityManager.getAllEntitiesByTypeAndTeam(BuildingEntityID.Mine, TeamNumbers.Neutral);
