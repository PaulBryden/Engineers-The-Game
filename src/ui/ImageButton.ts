...
class ImageButton extends Phaser.GameObjects.Container 
{
    ...
    {
        const backgroundButton:Phaser.GameObjects.Image = scene.add.image(2,2,background_unpressed);
        backgroundButton.displayWidth=150;
        backgroundButton.displayHeight=150;
        const buttonPressed:Phaser.GameObjects.Image = scene.add.image(0,0,background_pressed);
        buttonPressed.displayWidth=150;
        buttonPressed.displayHeight=150;
        const iconImage:Phaser.GameObjects.Image = scene.add.image(0,0,icon);
        const scaleRatio:number = backgroundButton.displayWidth/iconImage.displayWidth;
